...
Partial Class Forms_frmprojectionDetails
    ...
    Private Sub BindDataGrid()
        ...
        dsReport = objDB.ExecProc_getDataSet("[D_SP_GET_PROJECTION_DETAIL_DATA]", varParam)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For Each gvrow As GridViewRow In gdvprojection.Rows
