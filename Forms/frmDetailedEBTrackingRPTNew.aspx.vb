...
Partial Class Forms_frmDetailedEBTrackingRPTNew
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            viewer.LocalReport.ReportPath = Server.MapPath("../Reports/EBDetailedTrackingReport.rdlc")
            dsCustomer = Nothing
            dsCustomer = objDB.ExecProc_getDataSet("D_SP_EB_DETAILED_REPORT", varParam)
            reportDataSource.Name = "DataSet1_D_SP_EB_DETAILED_REPORT"
