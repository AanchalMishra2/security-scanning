<%@ Page Language="VB" MasterPageFile="~/TestMaster.master" AutoEventWireup="false" CodeFile="frmFundUtilizationPercentRpt.aspx.vb" Inherits="Forms_frmFundUtilizationPercentRpt" title="Energy Tracker" %>
...
<div class="strip">
    ...
    function openWindow()
       ...
       // debugger;
        ...
        if (Page_IsValid) {
            // do something
             window.open("frmFundUtilizationPercentRptNEW.aspx?param=" + document.getElementById('<%=ddlCustomer.ClientID%>').value + "&c=" +document.getElementById('<%=ddlCircle.ClientID%>').value +"&f=" + document.getElementById('<%=txt_frmdt.ClientID%>').value+"&t=" + document.getElementById('<%=txt_todt.ClientID%>').value +"");
            //alert('Page is valid!');                
                }
        else {
            // do something else
