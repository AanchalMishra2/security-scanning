<%@ Page Language="VB" MasterPageFile="~/TestMaster.master" AutoEventWireup="false" CodeFile="frmprojectionDetails.aspx.vb" Inherits="Forms_frmprojectionDetails" title="Energy Tracker" %>
        ...
        <RowStyle CssClass="rowstyle" />
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <asp:TextBox ID="txtDieselunit" Text='<% #Eval("D_DIESEL_UNIT") %>' runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <asp:TextBox ID="txtebunit" Text='<% #Eval("D_EB_UNIT") %>' runat="server"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                <ItemTemplate>
                <asp:HiddenField ID="d_site_no" Value='<%# Eval("D_S_NO") %>' runat="server" />
