...
Partial Class Forms_frmListDealer
    ...
    Protected Sub btnview_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnview.Click
        ...
        Try
            ...
            dsUserMstr = objDB.ExecProc_getDataSet("D_SP_GET_DEALER_LIST", varParam)
            ...
            viewer.LocalReport.ReportPath = Server.MapPath("../Reports/ListDealer.rdlc")
            dsUserMstr = Nothing
            dsUserMstr = objDB.ExecProc_getDataSet("D_SP_GET_DEALER_LIST", varParam)
            reportDataSource.Name = "DataSet1_D_SP_GET_DEALER_LIST"
