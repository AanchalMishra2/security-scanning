...
Partial Class Forms_frmVendorRPT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Request.QueryString("Mode") = "D" Then
                ...
                viewer.LocalReport.ReportPath = Server.MapPath("../Reports/DetailedVendorReport.rdlc")
                dsCustomer = Nothing
                dsCustomer = objDB.ExecProc_getDataSet("D_SP_VENDORSIDE_PURCHASE_REPORT_NEW", varParam)
                reportDataSource.Name = "DataSet1_D_SP_VENDORSIDE_PURCHASE_REPORT_NEW"
