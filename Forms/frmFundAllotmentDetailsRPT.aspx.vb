...
Partial Class Forms_frmFundAllotmentDetailsRPT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            viewer.LocalReport.ReportPath = Server.MapPath("../Reports/FundAllotmentDetailsDD.rdlc")
            dsCustomer = Nothing
            dsCustomer = objDB.ExecProc_getDataSet("D_SP_FUND_ALLOTMENT_REPORT_DD", varParam)
            reportDataSource.Name = "DataSet1_D_SP_FUND_ALLOTMENT_REPORT_DD"
