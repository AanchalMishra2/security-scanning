...
Partial Class Forms_frmListPetrocard
    ...
    Public Sub BindCustomer()
        Try
            ...
            arrParameter(0, 1) = CInt(Session("USER_ID"))
            DrRolName = objClsdb.ExecProc_getDataReder("D_SP_GET_CUSTOMER", arrParameter)
    ...
    Protected Sub btnview_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnview.Click
        ...
        Try
            ...
            'dsUserMstr = objDB.ExecProc_getDataSet("D_SP_GET_PETRO_CARD_LIST", varParam)
            ...
            viewer.LocalReport.ReportPath = Server.MapPath("../Reports/ListPetroCards.rdlc")
            dsUserMstr = Nothing
            dsUserMstr = objDB.ExecProc_getDataSet("D_SP_GET_PETRO_CARD_LIST", varParam)
            reportDataSource.Name = "DataSet1_D_SP_GET_PETRO_CARD_LIST"
