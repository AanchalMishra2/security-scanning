<%@ Page Language="VB" MasterPageFile="~/TestMaster.master" AutoEventWireup="false" CodeFile="frmDetailedEBTrackingRpt.aspx.vb" Inherits="Forms_frmDetailedEBTrackingRpt" title="Energy Tracker" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="strip">
        <h1>
            Detailed Report For EB Tracking
        </h1>
    </div>
    <div class="clear">
    </div>
                    ...
                    <tr>
                        <td colspan="4" align="center">
                            <asp:Button CssClass="input_btn input_text_x" OnClientClick=" Javascript:openWindow()"
                                ValidationGroup="rpt" ID="btnview" runat="server" Text="View" />
    ...
    function openWindow()
       ...
       // debugger;
        ...
        if (Page_IsValid) {
            // do something
             window.open("frmDetailedEBTrackingRPTNew.aspx?param=" + document.getElementById('<%=ddlCustomer.ClientID%>').value + "&c=" +document.getElementById('<%=ddlCircle.ClientID%>').value +"&f=" + document.getElementById('<%=txt_frmdt.ClientID%>').value+"&t=" + document.getElementById('<%=txt_todt.ClientID%>').value +"");
            //alert('Page is valid!');                
                }
        else {
            // do something else
