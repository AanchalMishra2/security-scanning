<%@ Page Language="VB" MasterPageFile="~/TestMaster.master" AutoEventWireup="false"
    CodeFile="frmSummaryReportFAFU.aspx.vb" Inherits="Forms_frmSummaryReportFAFU"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="strip">
        <h1>
            Fund Allotment And Utilization Report
        </h1>
    </div>
    <div class="clear">
    </div>
    ...
    function openWindow()
       ...
       // debugger;
        ...
        if (Page_IsValid) {
            // do something
             window.open("frmSummaryFAFURPT.aspx?param=" + document.getElementById('<%=ddlCustomer.ClientID%>').value + "&c=" +document.getElementById('<%=ddlCircle.ClientID%>').value +"&f=" + document.getElementById('<%=txt_frmdt.ClientID%>').value+"&t=" + document.getElementById('<%=txt_todt.ClientID%>').value +"");
            //alert('Page is valid!');                
                }
        else {
            // do something else
