<%@ Page Language="VB" MasterPageFile="~/TestMaster.master" AutoEventWireup="false"
    CodeFile="frmPetrocardFundUtiPercentage.aspx.vb" Inherits="Forms_frmPetrocardFundUtiPercentage"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="strip">
        <h1>
            Petrocard Funding And Utilization Report
        </h1>
    </div>
    <div class="clear">
    </div>
    ...
    function openWindow()
       ...
       // debugger;
        ...
        if (Page_IsValid) {
                ...
                //if(param=="S"){
                window.open("frmPetrocardFundUtiPercentageRPT.aspx?param=" + document.getElementById('<%=ddlCustomer.ClientID%>').value + "&c=" +document.getElementById('<%=ddlCircle.ClientID%>').value + "&v=" +document.getElementById('<%=ddlvendor.ClientID%>').value + "&f=" + document.getElementById('<%=txt_frmdt.ClientID%>').value+"&t=" + document.getElementById('<%=txt_todt.ClientID%>').value +"");
                //}
