...
Partial Class Forms_frmSiteWisePurchaseSummaryRPT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            varParam(2, 0) = "@strSiteId"
            varParam(2, 1) = Request.QueryString("s")
            ...
            dsCustomer = objDB.ExecProc_getDataSet("T_SP_SITE_WISE_PURCHASE_SUMMARY_REPORT", varParam)
            Dim datasource As ReportDataSource = New ReportDataSource("DataSet1_T_SP_SITE_WISE_PURCHASE_SUMMARY_REPORT", dsCustomer.Tables(0))
