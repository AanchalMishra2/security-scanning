<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSiteWisePurchaseSummaryRPT.aspx.vb" Inherits="Forms_frmSiteWisePurchaseSummaryRPT" %>
...
<body>
    ...
    <asp:Panel  Visible="false" ID="pnlrpt" runat="server">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="200px" Width="951px" ><localreport 
            reportpath="Reports\siteWisePurchaseSummary.rdlc"><datasources><rsweb:ReportDataSource 
                    DataSourceId="ObjectDataSource1" 
                    Name="DataSet1_T_SP_SITE_WISE_PURCHASE_SUMMARY_REPORT" />
            </datasources>
        </localreport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" 
            TypeName="DataSet1TableAdapters.T_SP_SITE_WISE_PURCHASE_SUMMARY_REPORTTableAdapter">
            <SelectParameters>
                <asp:Parameter Name="intCustomerId" Type="Int64" />
                <asp:Parameter Name="intCircleId" Type="Int64" />
                <asp:Parameter Name="strSiteId" Type="String" />
                <asp:Parameter Name="strFromDate" Type="String" />
                <asp:Parameter Name="strToDate" Type="String" />
