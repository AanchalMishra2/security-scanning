...
Partial Class Forms_frmEnergyprojectionVsActualRPT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            varParam(2, 0) = "@month"
            varParam(2, 1) = Request.QueryString("m")
            varParam(3, 0) = "@year"
            varParam(3, 1) = Request.QueryString("y")
            ...
            If Request.QueryString("Mode") = "D" Then
                ...
                viewer.LocalReport.ReportPath = Server.MapPath("../Reports/ProjectionDetailed.rdlc")
                dsCustomer = Nothing
                dsCustomer = objDB.ExecProc_getDataSet("D_SP_PROJECTION_DETAILED_REPORT", varParam)
                reportDataSource.Name = "DataSet1_D_SP_PROJECTION_DETAILED_REPORT"
            ...
            ElseIf Request.QueryString("Mode") = "S" Then
                ...
                viewer.Height = 480
                ' giving path to report
                viewer.LocalReport.ReportPath = Server.MapPath("../Reports/ProjectionSummary.rdlc")
                dsCustomer = Nothing
                dsCustomer = objDB.ExecProc_getDataSet("D_SP_PROJECTION_SUMMARY_REPORT", varParam)
                reportDataSource.Name = "DataSet1_D_SP_PROJECTION_SUMMARY_REPORT"
                reportDataSource.Value = dsCustomer.Tables(0)
                viewer.LocalReport.DataSources.Add(reportDataSource)
                pnlrpt.Controls.Add(viewer)
            End If
