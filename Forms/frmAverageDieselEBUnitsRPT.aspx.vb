...
Partial Class Forms_frmAverageDieselEBUnitsRPT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            viewer.LocalReport.ReportPath = Server.MapPath("../Reports/AverageDieselEBUnits.rdlc")
            dsCustomer = Nothing
            dsCustomer = objDB.ExecProc_getDataSet("D_SP_AVERAGE_DIESEL_EB_UNITS_NEW", varParam)
            reportDataSource.Name = "DataSet1_D_SP_AVERAGE_DIESEL_EB_UNITS_NEW"
