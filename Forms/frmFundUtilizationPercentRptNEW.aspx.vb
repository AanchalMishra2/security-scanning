...
Partial Class Forms_frmFundUtilizationPercentRptNEW
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            viewer.LocalReport.ReportPath = Server.MapPath("../Reports/FundUtilizationPercentageNew.rdlc")
            dsCustomer = Nothing
            dsCustomer = objDB.ExecProc_getDataSet("D_SP_FUND_UTILIZATION_CIRCLE_PERCENTAGE", varParam)
            reportDataSource.Name = "DataSet1_D_SP_FUND_UTILIZATION_CIRCLE_PERCENTAGE"
