...
Partial Class Forms_frmFundAllotementAllRPT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Request.QueryString("Mode") = "D" Then
                ...
                viewer.LocalReport.ReportPath = Server.MapPath("../Reports/FundAllotmentDetailed.rdlc")
                dsCustomer = Nothing
                dsCustomer = objDB.ExecProc_getDataSet("d_sp_detailed_fund_allotment_report", varParam)
                reportDataSource.Name = "DataSet1_d_sp_detailed_fund_allotment_report"
            ...
            ElseIf Request.QueryString("Mode") = "S" Then
                ...
                viewer.Height = 480
                ' giving path to report
                viewer.LocalReport.ReportPath = Server.MapPath("../Reports/FundAllotmentSummary.rdlc")
                dsCustomer = Nothing
                dsCustomer = objDB.ExecProc_getDataSet("d_sp_summary_fund_allotment_report", varParam)
                reportDataSource.Name = "DataSet1_d_sp_SUMMARY_fund_allotment_report"
                reportDataSource.Value = dsCustomer.Tables(0)
                viewer.LocalReport.DataSources.Add(reportDataSource)
                pnlrpt.Controls.Add(viewer)
            ElseIf Request.QueryString("Mode") = "P" Then
                viewer.Width = 951 'set height and width to rpt
                viewer.Height = 480
                ' giving path to report
                viewer.LocalReport.ReportPath = Server.MapPath("../Reports/FundAllotmentPercentage.rdlc")
                dsCustomer = Nothing
                dsCustomer = objDB.ExecProc_getDataSet("D_SP_FUND_ALLOTMENT_PERCENTAGE_REPORT", varParam)
                reportDataSource.Name = "DataSet1_D_SP_FUND_ALLOTMENT_PERCENTAGE_REPORT"
                reportDataSource.Value = dsCustomer.Tables(0)
                viewer.LocalReport.DataSources.Add(reportDataSource)
                pnlrpt.Controls.Add(viewer)
            End If
