...
Partial Class Forms_frmMainAccFundAllotRPTNew
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            varParam(2, 0) = "@intVendorId"
            varParam(2, 1) = Request.QueryString("v")
            varParam(3, 0) = "@strFromDate"
            varParam(3, 1) = Request.QueryString("f")
            varParam(4, 0) = "@strToDate"
            varParam(4, 1) = Request.QueryString("t")
            varParam(5, 0) = "@strMainAccNO"
            varParam(5, 1) = Request.QueryString("m")
            varParam(6, 0) = "@intUserId"
            varParam(6, 1) = CInt(Session("USER_ID"))
            ...
            viewer.LocalReport.ReportPath = Server.MapPath("../Reports/MainAccFundAllotment.rdlc")
            dsCustomer = Nothing
            dsCustomer = objDB.ExecProc_getDataSet("D_SP_MAIN_ACCOUNT_TRANSACTION_REPORT_NEW", varParam)
            reportDataSource.Name = "DataSet1_D_SP_MAIN_ACCOUNT_TRANSACTION_REPORT_NEW"
