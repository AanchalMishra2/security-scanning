<%@ Page Language="VB" MasterPageFile="~/TestMaster.master" AutoEventWireup="false" CodeFile="frmAssignCircle.aspx.vb" Inherits="Forms_frmAssignCircle" title="Energy Tracker" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div class="strip"><h1>Assign Circle</h1></div>
   <div class="clear"></div>
    <table class="style5">
     <tr>
            <td class="style7">
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="ddlcustomer" CssClass="ValidationMessage" Display="Dynamic" 
