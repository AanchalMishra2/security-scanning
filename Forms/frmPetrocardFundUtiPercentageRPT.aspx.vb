...
Partial Class Forms_frmPetrocardFundUtiPercentageRPT
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            varParam(5, 0) = "@intUserId"
            varParam(5, 1) = CInt(Session("USER_ID"))
            ...
            viewer.LocalReport.ReportPath = Server.MapPath("../Reports/PetrocardUtilizationRPT.rdlc")
            dsCustomer = Nothing
            dsCustomer = objDB.ExecProc_getDataSet("D_SP_PRETOCARD_FUNDING_UTILIZATION_PERCENT_REPORT_NEW", varParam)
            reportDataSource.Name = "DataSet1_D_SP_PRETOCARD_FUNDING_UTILIZATION_PERCENT_REPORT_NEW"
