<%@ Page Language="VB" MasterPageFile="~/TestMaster.master" AutoEventWireup="false" CodeFile="frmAverageDieselEBUnits.aspx.vb" Inherits="Forms_frmAverageDieselEBUnits" title="Energy Tracker" %>
...
<div class="strip">
        <h1>
            Average Diesel And EB Units Report
        </h1>
    </div>
    <div class="clear">
    </div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="req_frmdt" ValidationGroup="rpt" runat="server" ControlToValidate="txt_frmdt"
                    ...
                    <asp:RegularExpressionValidator ID="revfrmdt" ValidationGroup="rpt" ControlToValidate="txt_frmdt"
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="req_todt" ValidationGroup="rpt" runat="server" ControlToValidate="txt_todt"
                    ...
                    <asp:RegularExpressionValidator ID="revtodt" ValidationGroup="rpt" ControlToValidate="txt_todt"
                        ValidationExpression="^([0]?[1-9]|[1|2][0-9]|[3][0|1])[./-]([0]?[1-9]|[1][0-2])[./-]([0-9]{4}|[0-9]{2})$"
                        runat="server" ErrorMessage="Check Date Format (DD/MM/YYYY)">*</asp:RegularExpressionValidator>
                    ...
                    <cc1:ValidatorCalloutExtender ID="vcecmdate" runat="server" TargetControlID="cmdate">
                    </cc1:ValidatorCalloutExtender>
                </td>
            </tr>
            <tr>
                <td colspan="4" align="center">
                    <asp:Button CssClass="input_btn input_text_x" OnClientClick=" Javascript:openWindow()"
                        ValidationGroup="rpt" ID="btndetailed" runat="server" Text="View" />
                   <asp:Button CssClass="input_btn input_text_x" Visible="true" ID="btnreset" runat="server"
                        Text="Reset" />
                    &nbsp;
                </td>
            </tr>
    ...
    function openWindow()
       ...
       // debugger;
        ...
        if (Page_IsValid) {
                ...
                window.open("frmAverageDieselEBUnitsRPT.aspx?param=" + document.getElementById('<%=ddlCustomer.ClientID%>').value + "&c=" +document.getElementById('<%=ddlCircle.ClientID%>').value + "&f=" + document.getElementById('<%=txt_frmdt.ClientID%>').value+"&t=" + document.getElementById('<%=txt_todt.ClientID%>').value +"");
