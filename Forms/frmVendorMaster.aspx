<%@ Page Language="VB" MasterPageFile="~/TestMaster.master" AutoEventWireup="false" CodeFile="frmVendorMaster.aspx.vb" Inherits="Forms_frmVendorMaster" title="Energy Tracker" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div class="strip"><h1>Manage Vendor</h1></div>
   <div class="clear"></div>
    <table style="width:100%" class="style1">
        ...
        <tr>
            ...
            <table width="100%"> <tr><td align="center"><asp:Label ID="lblWarningMessage" runat="server" Visible="true" Font-Bold="True" ForeColor="#C00000" 
                ...
                GridLines="None" DataKeyNames="D_VENDOR_ID"  
              ...
              <asp:TemplateField  HeaderText="Edit">
                   <ItemTemplate>
                    ...
                    <asp:HiddenField ID="hfCircleID" runat="server" Value='<%# Bind("D_VENDOR_ID") %>' />
            ...
            <table>
             ...
             <tr>
                 <td  class="style12">
                     Vendor Name :</td>
            <td  class="style11">
                <asp:TextBox ID="txtVendorName" runat="server" CssClass="textboxS"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtVendorName" CssClass="ValidationMessage" 
