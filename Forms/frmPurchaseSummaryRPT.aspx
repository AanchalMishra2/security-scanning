<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmPurchaseSummaryRPT.aspx.vb" Inherits="Forms_frmPurchaseSummaryRPT" %>
...
<body>
    ...
    <asp:Panel Visible="false"  ID="pnlrpt" runat="server">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            Font-Size="8pt" Height="480px" Width="951px"><localreport 
            reportpath="Reports\puchaseSummary.rdlc"><DataSources><rsweb:ReportDataSource 
                    DataSourceId="ObjectDataSource1" 
                    Name="DataSet1_T_SP_CIRCLE_WISE_PURCHASE_SUMMARY_REPORT" />
            </DataSources>
        </localreport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            TypeName="DataSet1TableAdapters.T_SP_CIRCLE_WISE_PURCHASE_SUMMARY_REPORTTableAdapter">
            <SelectParameters>
