<%@ Page Language="VB" MasterPageFile="~/TestMaster.master" AutoEventWireup="false"
    CodeFile="frmFundAllotmentDetails.aspx.vb" Inherits="Forms_frmFundAllotmentDetails"
    ...
    function openWindow(param)
       ...
       // debugger;
        ...
        if (Page_IsValid) {
                ...
                window.open("frmFundAllotmentDetailsRPT.aspx?param=" + document.getElementById('<%=ddlCustomer.ClientID%>').value + "&c=" +document.getElementById('<%=ddlCircle.ClientID%>').value + "&f=" + document.getElementById('<%=txt_frmdt.ClientID%>').value+"&t=" + document.getElementById('<%=txt_todt.ClientID%>').value +"");
                //}
